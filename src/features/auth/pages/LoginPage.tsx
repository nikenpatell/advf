    ...
    switch (role) {
      case "ORG_ADMIN":
        return {
          ...
          icon: ShieldCheck,
          desc: "Full control over firm settings and personnel.",
        };
      case "TEAM_MEMBER":
        return {
          label: "Team Member",
          icon: Briefcase,
          desc: "Access assigned cases and workspace tasks.",
        };
      case "CLIENT":
        return {
          label: "Client",
          icon: UserCircle2,
          desc: "Monitor your cases and communicate with your team.",
        };
      default:
        return {
          label: role,
    ...
    <div className="grid gap-6">
      <div className="flex flex-col space-y-2 text-center mb-2">
        ...
        <p className="text-xs text-muted-foreground">
          ...
          {step === "PASSWORD" &&
            `Enter your password to access as ${selectedRole?.replace("_", " ")}`}
        </p>
      </div>
        ...
        <div className="grid gap-4">
          {step === "EMAIL" && (
            <div className="grid gap-2">
              <Label
                htmlFor="email"
                className="font-bold text-[11px] uppercase tracking-wider text-muted-foreground"
              >
                Work Email
              </Label>
              <Input
              ...
              <Button
                ...
                className="w-full h-11 rounded-full bg-primary hover:bg-primary/90 font-bold mt-2 transition-all"
              >
                {loading ? (
            ...
            <div className="grid gap-4">
              <div className="flex items-center gap-3 p-3 rounded-2xl bg-muted/50 border border-border/50">
                ...
                <button
                  ...
                  onClick={() =>
                    setStep(availableRoles.length > 1 ? "ROLE" : "EMAIL")
                  }
                >
                  Change
                </button>
