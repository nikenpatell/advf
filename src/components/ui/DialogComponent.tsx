...
export const DialogPortal = ({ children }: any) => <div>{children}</div>;
export const DialogOverlay = ({ children }: any) => <div>{children}</div>;
export const DialogClose = ({ children }: any) => <div>{children}</div>;
